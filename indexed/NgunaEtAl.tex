...
Differential object agreement constrained by the specificity of the object is attested, for instance, in \ili{Paluan}. According to \citet[218]{Woolford2000}, a definite and specific object in this language triggers verbal agreement, whereas an indefinite object does not \REF{ex:nguna:2}.

\todo{alignment ok - e.g. Palauan "a bilis" corresponds to \ili{English} 'dog'}
\ea\label{ex:nguna:2}
\ea
...
\begin{table}
\caption{\ili{Emakhuwa}: [-\textsc{human, -animate}] nouns of classes 5, 7, and 9}
\label{tab:nguna:1}

\begin{tabularx}{\textwidth}{XXXX}
\lsptoprule

 Class 5  (Singular)& \ili{English}& Class 6 (Plural)& Class 2  (Plural)\\
 \midrule 
...
\\ 
 ...
 Class 7 (Singular)& \ili{English}& Class 8 (Plural)& Class 2  (Plural)\\
 \midrule 
 ...
 \\
 Class 9  (Singular)& \ili{English}& Class 10  (Plural)& Class 2 (Plural)\\
 \midrule
...
\caption{\ili{Emakhuwa}: [-human, +animate] nouns of classes 5, 7, and 9}
\label{tab:nguna:2}
...
\footnotetext{{The particle}{a} {occurs only in some dialectical varieties of \ili{Changana} and \ili{Rhonga}. When it precedes a DP object, its major role is to encode definiteness and indicate that the referent of that object has already been given in previous discourse. }} 


\ea\label{ex:nguna:22}
\ea
{\ili{Changana} (inanimate object)}\\
