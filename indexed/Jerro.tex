...
\ex\label{martendress}\ili{Swahili} \begin{xlist}
	\ex \gll \ili{Ju|’hoan}ma a-li-va-a kanzu\\
\ili{Ju|’hoan}ma 1S-{\scshape pst}-wear-{\scshape fv} kanzu\\
	\glt `\ili{Ju|’hoan}ma was wearing a Kanzu.'
	\ex\gll \ili{Ju|’hoan}ma a-li-val-i-a nguo rasmi.\\
\ili{Ju|’hoan}ma {\scshape 1S-pst}-wear-{\scshape appl-fv} clothes official\\
	\glt `\ili{Ju|’hoan}ma was dressed up in official/formal clothes.'
	\ex\gll \#\ili{Ju|’hoan}ma a-li-val-i-a kanzu.\\
\ili{Ju|’hoan}ma {\scshape 1S-pst}-wear-{\scshape appl-fv} kanzu\\
	\glt Intended: `\ili{Ju|’hoan}ma was wearing a Kanzu.' \citep[9]{Marten2003} %\REF{ex:jerro:14}
	\end{xlist}
\end{exe}
%
...
\ex\label{stravinsky:2}\gll Habimana a-ri ku-vug-ir-a mu n-zu.\\
			Habimana 1S-{\scshape be} {\scshape inf}-talk-{\scshape appl-imp} 18 9-house\\
				\glt `Habimana is talking in the house.'
\end{exe}
 From these diagnostics, I conclude that  locative phrases in \ili{Kinyarwanda} are class-marked arguments and not oblique phrases. 
