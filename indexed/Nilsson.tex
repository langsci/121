...
From a typological point of view, variation between agreement in the singular and the plural is quite common. It is reported from a diversity of languages, and it occurs, for instance, in both \ili{Swedish} and \ili{English} with words such as ‘the team’, as in \REF{ex:nilsson:5} and \REF{ex:nilsson:6}.
...
\begin{table}
\caption{\ili{Somali} corporate nouns}[b]
...
Typologically, many languages also exhibit variation in number when nouns are used with a generic meaning. \ili{English}, as well as \ili{Swedish}, exhibits such variation between the definite singular and the indefinite plural form of the generic noun itself, as shown in \REF{ex:nilsson:10}.
