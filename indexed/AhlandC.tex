...
The negative enclitic /=cé/ [kʲé] in \ili{Daatsʼíin} \REF{ex:ahlandc:41} attaches to the end of the verb word and appears to be cognate with \textbf{=c\^{e}} of the \ili{Sirba} Abay dialect of Southern \ili{Gumuz} \REF{ex:ahlandc:42} \citep[cf.][241-242]{Ahland2012Gumuz}. 
...
\ili{Daatsʼíin} has four prepositional proclitics: /ká=/ ‘to, for’ (dative) \REF{ex:ahlandc:23}, \REF{ex:ahlandc:27}-\REF{ex:ahlandc:28}; /ka=/ ‘with’ (instrumental/comitative) \REF{ex:ahlandc:24}, \REF{ex:ahlandc:56}; /n\'{a}=/ ‘in, on, at, from’ (locative/ablative) \REF{ex:ahlandc:57}; and /jáá=/ ‘of’ (genitive).  The genitive construction \REF{ex:ahlandc:58} is distinct from the associative construction (\sectref{sec:ahlandc:8.1}) in that with the associative the possessor names a general category (e.g. ‘cow head’) and with the genitive the possessor names a more specific entity (e.g. ‘cow’s head’).
...
The \ili{English} list of words is taken from: \citet{HaspelmathTadmor2009}.

\begin{longtable}{p{.28\textwidth}  p{.32\textwidth} p{.32\textwidth}}
\lsptoprule
Word meaning & \ili{Daatsʼíin} & \ili{Gumuz} (S. \ili{Gumuz})\\
\midrule
1 fire & too & máánɟa \\
