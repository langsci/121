...
\ili{Bambassi}\index{Bambassi}{}-way-\textsc{source}    \textsc{aff}{}-1\textsc{sg}{}-come-\textsc{decl}\\
\glt `I came from \ili{Bambassi}\index{Bambassi}.'
\z
...
\ili{Bambassi}\index{Bambassi}{}-way-\textsc{obj}    run\textsc{{}-obj}     \textsc{aff-1sg}{}-try\textsc{{}-decl} \\
\glt `I tried running to \ili{Bambassi}\index{Bambassi}.'
\z
...
{\db}\ili{Bambassi}\index{Bambassi}{}-way\textsc{{}-obj}     run\textsc{{}-obj}      \textsc{aff-1sg}{}-want\textsc{{}-decl} \\
\glt `I want to run to \ili{Bambassi}\index{Bambassi}.'
\z
