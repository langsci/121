...
In this paper negation in \ili{Ndebele} has been examined across many different subcategories of the language. In \sectref{sec:burkholder:1} the distribution of negative morphemes in \ili{Ndebele} was captured using a complex featural system and bi-directional agreement. In \sectref{sec:burkholder:2} a proposal for the clausal structure of negative sentences in \ili{Ndebele} was proposed with respect to simple tense past and present verbal predicates. In the following sections this analysis was extended to cases where the negative affix \nga appears pre-verbally instead of post-verbally, as it does in the simple tense sentences. 
