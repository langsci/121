...
\caption{Languages included in this study}\footnotemark
\label{tab:1.nicolle}
\end{table}

\footnotetext{Languages are classified using the ISO 639-3 language code as cited in \textit{Ethnologue} \citep{lewisetal2015} and \citeauthor{maho2003}’s (\citeyear{maho2003}) updated version of \citeauthor{guthrie1967}’s (\citeyear{guthrie1967}) classification of the Bantu languages.}
...
\langinfo{}{}{Fuliiru \citep[350]{vanotterloo2011}}\\
...
\langinfo{}{}{Jita \citep[32]{pylerobinson2015}}\\
\gll Eyo mw=ibhara [wamembe]\textsubscript{TOPIC} [bhuri rusiku :aa-jaga\footnotemark mu=mugunda gwaye]\textsubscript{COMMENT}\\
there in=forest hyena every  day he.\textsc{pst}{}-went in=field his \\ \footnotetext{In this and subsequent examples glossing will be by word rather than by morpheme as a morpheme-based gloss is not necessary for the analysis of constituent order. In long examples, for reasons of space, only a free translation will be provided.}
...
\ea\label{ex:6.nicolle} \todo{please check gloss alignment fo this example}
\langinfo{}{}{Jita \citep[32]{pylerobinson2015}}\\
...
In \ref{ex:12.nicolle}, from Mwani, the conceptual topic does not change but is referred to using a noun phrase and proper names in the last clause. There is no discontinuity in the text as the order of events is iconically represented: they were called and then they came, and so the topic is right dislocated.
...
time when.it.arrived week that.they.agree they.were.called they.came those-two \textsc{name} and \textsc{name}\\
...
now she.sat woman that and things those she.cooked she.gave.to.them people\\
...
\langinfo{}{}{Rangi \citep[532--533]{stegen2011}}\\
\gll Aho kalɨ kwijáa na \textbf{moosi ʉmwɨ}, afuma iʉndii, maa \textbf{vatavana} navo viyokʉʉja, maa akavasea, “Mpokeri isɨrɨ raanɨ.” [Maa vakasiita]\textsubscript{COMMENT} [\textbf{vara vatavana}.]\textsubscript{TOPIC} Maa [\textbf{ʉra moosi}]\textsubscript{TOPIC} [akasea...]\textsubscript{COMMENT}\\
\\
...
In other languages, temporary topics are left dislocated. In the Bena example in \ref{ex:15.nicolle},  \textit{inyama} ‘meat’ is a left dislocated temporary topic; \textit{u}\textit{\nobreakdash-Mbwa} ‘Dog’ occurs after the verb because it receives argument focus (see \sectref{§4:expression.nicolle}).
...
Leopard he.went to uncle to.greet misfortune meat he.left he.looks.at Dog\\
...
when he.went and.arrived he.told.her his.wife \textsc{quot} my.wife cook staple.food sauce I.will.know myself \\
...
land that they.were living-there women only \textsc{cop=3pl} they.were they.had.stolen cows of Mariro \\
...
now when he.was.herding day another buffalo it.came in-group of their.place that\\
