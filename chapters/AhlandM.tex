...
\multicolumn{3}{l}{\textsc{dem}   [[\textsc{inf}] + -(i)t}]\textsubscript{\textsc{rel}} & \multicolumn{2}{l}{\textsc{sbj-} Copula} \\
há  & {\db}{\db}hez    &    -t     &      í-  & nè\\
