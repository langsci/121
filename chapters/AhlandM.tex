...
\begin{table}
\caption{Constituent order typology of Northern Mao (from \citealt[48]{Ahland2012Mao})}
\label{tab:mahland:1}
  	\centering
...
\begin{table}
\caption{Tone classes of selected roots with distinct finite, infinitive, and noun\index{Noun} stems}
\label{tab:mahland:3}
\fittable{
...
\subsection{Infinitive stems in complement and adverbial constructions}\label{sec:mahland:2.1}
  ...
  The infinitive stem is the simplest deverbal nominalization structure in Northern Mao; infinitive stems are commonly used for action and participant nominalization \citep[222]{Ahland2012Mao}. Examples \REF{ex:mahland:33}-\REF{ex:mahland:35} illustrate simple subject complements with infinitive stems. 
...
A finite verb stem in a complement construction can take an object \REF{ex:mahland:36}, \REF{ex:mahland:38}, \REF{ex:mahland:39}.\footnote{Movement predications appear to be a subset of transitive constructions in NM; as a result, semantic Goals are marked with the /-na/ OBJ case marker (cf. \citealt[335-339]{Ahland2012Mao}).} It may be that constructions like \REF{ex:mahland:36}, \REF{ex:mahland:38}, and \REF{ex:mahland:39} are nominalizations of a verb phrase \citep[625]{Ahland2012Mao}.
...
In NM, the choice of infinitive vs. finite verb stem in subordinate structures correlates with several finiteness-related features: infinitive stems are used only with subordinate verbs which are not overtly marked for subject (i.e. which share the same subject as their matrix verb). Finite stems, on the other hand, may be used on same-subject subordinate structures, but they are required on subordinate verbs which carry overt subject markers or which include some internal structure (e.g. an object NP, oblique, or adverbial) in the subordinate clause (cf. \citealt[612, 630]{Ahland2012Mao}). 

\subsection{Relativization}\label{sec:mahland:2.2}

Relativization is a nominalizing process in NM \citep[225]{Ahland2012Mao}. Relativized verbs are marked with the suffix /-(i)t/.The simplest and most highly nominal relative clause\index{subordination!relative clauses} is headless—i.e. it does not modify a head noun; this form is subject-less. It can carry case in relevant syntactic environments \REF{ex:mahland:40}-\REF{ex:mahland:41} and can be marked for number \REF{ex:mahland:41}. Example \REF{ex:mahland:42} illustrates the non-relativized finite matrix verb\index{verb} `come.' 
...
With respect to the jussive construction in \REF{ex:mahland:63}, the /ne/ form in the impersonal jussive \REF{ex:mahland:63} is a recognizable copula in Northern Mao \REF{ex:mahland:64} \citep[463]{Ahland2012Mao}.
...
In fact, in the past progressive construction there are two cases of historical relativization. The past copula form /bitè/ is itself a relativization of the existential verb /biʃ/ (cf. \citealt[318; 461-462]{Ahland2012Mao}, and the highlighted form in \REF{ex:mahland:69}): /biʃ -t/ {>} /bi-t/ \textsc{exist-rel}. In \REF{ex:mahland:69}'s matrix clause, the cleft with present meaning requires no copula (i.e. a zero copula); while in \REF{ex:mahland:70}, the past copula is used (in this instance, the form /bitè/ is not a functional auxiliary). 
...
The past copula form is a frozen form like all other Northern Mao copulas today \citep[465]{Ahland2012Mao}.
