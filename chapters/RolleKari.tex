...
{\sc{fe}} & {factative tense/aspect} \\

{\sc{fut}} & {future} \\

{\sc{inaux}} & {inceptive nonimperative auxiliary} \\

{\sc{iter}} & {iterative} \\

{\sc{neg}} & {negative} \\

{\sc{nie}}  & {negative imperative} \\
