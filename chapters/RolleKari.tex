...
\gllll
~      \hphantom{c}\textsc{cl}=( ~   ~  ~    ~   )=\textsc{cl}\\
($_\omega$    )  ($_\omega$   )  \hphantom{c}\textbf{Ø}    \hphantom{c}($_\omega$  )  \\
{\db}N ~        {\db}V   ~  \hphantom{c}\textbf{σ}    \hphantom{c}{\db}V   \\
{\db}Breno  ~   {\db}ḍuw ~  \hphantom{c}\textbf{me}   \hphantom{c}{\db}tạ {} \\ 
\glt \vphantom{l}
\ex prosodically heavy pronouns\\
\gllll
  ~         \hphantom{c}\textsc{cl}=( ~                 )=\textsc{cl} ~    ~   ~   \textsc{cl}=( ~               )=\textsc{cl}\\
