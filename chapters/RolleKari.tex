...
\end{table}
\todo[inline]{Table 1 needs to restore missing "3rd" "Set 2" column, as in the original manuscript. Also center "1st", "2nd", "3rd" between each of the respective "Set 1" and "Set 2" columns.}
...
\end{tabularx}
\end{table}
\todo[inline]{Author wants line "V=cl XP"+ t be vertically centered in the blank space between the "SG" and "PL" blocks; but horizontally to the right where it is. (Also, can "SG" and "PL" row headings can be centered vertically between the first and second, and third and fourth rows, respectively - aesthetic issue.) }
