...
{\scshape pl} & {\itshape ení}  
		  ...
		  & {V pron\textsubscript{$\sigma $}\textbf{=\textsc{cl}}} {V pron\textsubscript{$\sigma $}\textbf{=\textsc{cl}}} 
		      & { } \\
\lspbottomrule
\end{tabularx}
\end{table}
...
\begin{tabularx}{\textwidth}{XXXXX}
\lsptoprule
Mono-verbal & \multicolumn{2}{c}{Serial verb construction} & \\
  & & {V V} & \multicolumn{2}{c}{V $\sigma $ V}\\
{Factative} & {o=\'{V}=n} & {o=\'{V} \'{V}=n} & \multicolumn{2}{c}{{o=\'{V} $\sigma $ \'{V}=n}}\\
{Perfect} & {o=\'{V}=tē} & {o=\'{V} \'{V}=tē} & \multicolumn{2}{c}{{o=\'{V} $\sigma $ \'{V}=tē}}\\
{Present/Habitual} & {mó=\'{V}} & {o=\'{V} mō=\'{V}} & \multicolumn{2}{c}{{o=\'{V} $\sigma $ mō=\'{V}}}\\
{Future} & {mó=\'{V}} & {mó=\'{V} \'{V}} & \multicolumn{2}{c}{{mó=\'{V} $\sigma $ \'{V}}}\\
\lspbottomrule
\end{tabularx}
...
In \REF{ex:rolle:53}, this HL negation tone also applies when the verb appears with another verb or a prosodically light pronoun, both Single-Marked contexts. Here, all elements in the complex are marked with low tone. We can compare this with Double-Marked contexts when there is a prosodically heavy intervening object. In \REF{ex:rolle:54}, the first verb and proclitic \textit{vọn} ‘take’ is marked with the HL negation pattern, whereas the second verb \textit{fịya} ‘cut’ is marked with H, outside of the scope of negative tone. Example \REF{ex:rolle:32b} illustrates that marking both verbs with HL negation is ungrammatical. 
