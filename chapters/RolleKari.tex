...
\shorttitlerunninghead{Degema clitics and serial verbs at the syntax/phonology interface}
\author{%
...
\maketitle
\begin{document}
\todo{shortened title in page header. OK?}
...
These patterns are summarized as a whole in Table \ref{table:rolle:4}.
