...
\todo[inline]{Please check the index \textsubscript{i} in this and all other examples! It was not clear from the original and could also be a \_i}
...
\ex\label{ex:burkholder:19a} \textit{zibe zihamba} \ensuremath\longrightarrow \textit{bezihamba} `they were walking/moving/going'\\
\textit{sibe sikhala} \ensuremath\longrightarrow \textit{besiskhala} `it was crying'

\ex\label{ex:burkholder:19b} \textit{ibe ihamba} \ensuremath\longrightarrow \textit{ibihamba} `it was walking'\\
...
\subsection{Accounting for \bee}\label{sec:burkholder:3.3.1}\todo[inline]{This section was moved up one level to comply with sectioning standards}
