...
\author{%
 Ross Burkholder \affiliation{University of Chicag}
}
...
\begin{exe}
\ex TP_{Adj, Past}: =AP, T -V +Past
\ex TP_{Adj, Present}: =BeP, +Adj, T -V -Past
\ex BeP: =AP, Be 
\end{exe}
...
TP_V: =VP, T +V
\\
TP_{Adj, Past}: =AP, T -V +Past
\\
TP_{Adj, Present}: =BeP +Adj, T -V -Past
\\
Be: =AP, Be 
\\
TP_{-Main}: =BeP -M, T -M
