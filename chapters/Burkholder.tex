...
\subsection{Background}\label{sec:burkholder:1.1}\todo{Please add another subsection to Section 1 or up grade Section 1.1 to Section 2}
...
\todo[inline]{Please check the index \textsubscript{i} in this and all other examples!}
...
\subsubsection{Accounting for \bee}\label{sec:burkholder:3.3.1}
