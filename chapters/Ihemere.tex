...
\todo[inline]{Can "Number \%" be aligned further to the right so the heading looks like it's over the correct column? In first column, can wrapped items be indented slightly so the reader can better see where each new line begins?}
