...
\end{tabularx}
\todo{check whether content of this table is as intended}
...
\begin{stylelsBulletList}
Asymmetry in source of verb inflections (outsider late system morphemes): As the analysis reported in \tabref{tab:2} clearly indicates, all verb inflections (100\%) of the bilingual clauses come from only one of the participating languages, Igbo.
\end{stylelsBulletList}
