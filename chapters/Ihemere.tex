...
\subsection{Sampling procedure}\label{sec:ihemere:4.2}
...
The speakers involved ranged in age from 20 to 55, including secondary school teachers (N = 15), engineers (N = 10), physicians (N = 4), nurses (N = 5), business owners (N = 4), and undergraduate students (N = 12). \tabref{tab:1} summarizes the occupation and sex of the speakers. 
...
As we highlighted in \sectref{sec:ihemere:3}, the Asymmetry Principle (AP) states that bilingual speech is characterized by asymmetry in terms of the roles played by the languages involved in CS \citep[9]{MyersScotton2002}. This asymmetry is evident in the foregoing analysis reported in \tabref{tab:2}. 
