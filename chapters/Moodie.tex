...
\label{fig:moodie:1}
\end{figure}
\todo[inline]{Please provide the raw data for this graph. From the image, I think it is: mammal: 40,6,2(?),bird: 23, 2, 1,reptile: 11,2,0,insect: 10,5,9,trees: 3,4,0,vegetation: 2,1,10,tool: 16,3,3}
