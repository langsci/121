...
\bfseries Replacement & { húng-ú}  fàìt-\^{i} & { hùng-à} fàìt-\^{o} & ‘knee’ ‘ebony tree’\\
\lspbottomrule
\end{tabularx}
...
\midrule
 hínè &  hìnè & \mdseries ‘goat’\\
 yànì &  yání & \mdseries ‘fruit, tree’\\
 mònyè &  mòny\^{e} & \mdseries ‘father’\\
\lspbottomrule
\end{tabularx}
...
\multicolumn{3}{c}{\textbf{Plurative}} & \multicolumn{3}{c}{\textbf{Singulative}}\\ \cmidrule(lr){1-3}\cmidrule(lr){4-6}
 ...
 ífòrí &  ìfòrí-há & ‘butterfly’ &  hìlófìr-\^{i} &  hìlòfìr & ‘bee sp.’\\
...
\multicolumn{3}{c}{ \textbf{Plurative}} & \multicolumn{3}{c}{ \textbf{Singulative}}\\ \cmidrule(lr){1-3}\cmidrule(lr){4-6}
 \textbf{Singular} & \textbf{Plural} & \textbf{English} & \textbf{Singular} & \textbf{Plural} & \textbf{English}\\ \midrule
 tìàng &  tìáng-ì & ‘animal’ &  cèng-\^{i} &  cèng & ‘bird’\\
...
\mdseries \textbf{Agentive} &  bara &  há-bárà-nì &  há-bàrà-k & ‘cow farmer’\\
&  itiyena &  há-itíyénà-nì &  há-itíyénà-k & ‘teacher’\\
&  toho &  há-tóhò-nì &  há-tòhò-k & ‘killer’\\
&  &  &  & \\
\mdseries \textbf{Other} &  &  mérò-nì &  méró-k & ‘enemy’\\
...
\lsptoprule
 ...
 tórú &  tòrú-ò &  tòrú-sèn & \mdseries ‘axe’\\
 gàrì &  gárí-jìn &  gárí-sèn & \mdseries ‘tracks’\\
 kérr &  kèrr-á &  kèrr-ítí & \mdseries ‘sheep’\\
\lspbottomrule
\end{tabularx}
