...
\stepcounter{CHAPTER}{\theCHAPTER}Niger-Congo transitive reciprocal constructions and polysemy with reflexives
\end{styleHeading}
...
\begin{listWWviiiNumxlileveli}
\item \ea\label{ex:}
\langinfo{}{}{\textstyleapplestylespan{Yoruba }}\\
\ea\label{ex:}
\langinfo{}{}{\textstyleapplestylespan{  }\textit{\`{A}wọn     obìnrin   náà  rí   }\textbf{\textit{ara   }}\textstyleapplestylespan{\textbf{\textit{wọn}}}\textit{        }}\\
\ea\label{ex:}
\langinfo{}{}{  they     women   the   see   body   their}\\
\ea\label{ex:}
\langinfo{}{}{  ‘The women see themselves/each other/their bodies.’ \textstyleapplestylespan{(ID1912)}}\\
\end{listWWviiiNumxlileveli}
\begin{listWWviiiNumxlileveli}
\item \ea\label{ex:}
\langinfo{}{}{Gungbe }\\
\ea\label{ex:}
\langinfo{}{}{  \textit{Náwè     lɔ  lɛ  ná  hù  }\textbf{\textit{yé-ɖé}}\textit{        }}\\
\ea\label{ex:}
\langinfo{}{}{  woman    \textsc{det}  \textsc{pl}  \textsc{fut}  kill  \textsc{3pl}{}-ɖé}\\
\ea\label{ex:}
\langinfo{}{}{  ‘The women will kill themselves/ each other.’ (ID3597)}\\
\end{listWWviiiNumxlileveli}
\begin{listWWviiiNumxlileveli}
\item \ea\label{ex:}
\langinfo{}{}{\textstyleapplestylespan{Fe’efe’e }}\\
\ea\label{ex:}
\langinfo{}{}{\textstyleapplestylespan{  }\textstyleapplestylespan{\textit{pʉ-nʒw\={i}ɛ   lɒfɛn     }}\textstyleapplestylespan{\textbf{\textit{n\={a}   jɒɒ}}}\textstyleapplestylespan{\textit{           }}}\\
\ea\label{ex:}
\langinfo{}{}{\textstyleapplestylespan{  }\textstyleapplestylespan{\textsc{c}}\textstyleapplestylespan{2-woman   }\textstyleapplestylespan{\textsc{pst2}}\textstyleapplestylespan{{}-sell   body   }\textstyleapplestylespan{\textsc{poss.det.c1}}}\\
\ea\label{ex:}
\langinfo{}{}{  ‘The women betrayed themselves/each other.’ \textstyleapplestylespan{(ID8237)}}\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Urhobo }\\
\ea\label{ex:}
\langinfo{}{}{  a.  \textit{ayen   mrẹ     }\textbf{\textit{ohwo-ohwo}}\textit{ }}\\
\end{listWWviiiNumxlileveli}
       they   see.\textsc{pst}   person-person \\
\glt   ‘They saw themselves/ each other.’ (ID2874)
\z

\glt b.  \textstylelsLanginfoChar{\textit{emo    na  fa    }}\textstylelsLanginfoChar{\textbf{\textit{oma-oma-rẹ-ayen}}}\textstylelsLanginfoChar{\textit{ }}
\z
...
\langinfo{}{}{Limbum}\\
\ea\label{ex:}
\langinfo{}{}{  \textit{Wèe  tʉr  à  rjà’-*(}\textbf{\textit{se}}\textit{)    }\textbf{\textit{mnyor}}\textit{      }}\\
\ea\label{ex:}
\langinfo{}{}{  \textsc{2pl}  have  \textsc{inf}  \textsc{inf}{}-help-\textbf{\textsc{pl.rcm}}  \textsc{c}6-bodies}\\
\ea\label{ex:}
\langinfo{}{}{  ‘We (pl) must help each other.’ \textstyleapplestylespan{(}Francis Ndi Wepngong pers. comm.\textstyleapplestylespan{)}}\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Lubukusu}\\
\ea\label{ex:}
\langinfo{}{}{  \textit{Bob  ne  Billi  ba-a-bon-*(}\textbf{\textit{an)}}\textit{{}-a     (}\textbf{\textit{ba-b-eene  khu b-eene}}\textit{)}}\\
\ea\label{ex:}
\langinfo{}{}{  Bob   and   Bill   \textsc{sm.c2-pst}{}-see-\textbf{\textsc{rcm}}\textsc{{}-fv}   \textsc{c2-c2}{}-own on \textsc{c2-c2}{}-own}\\
\ea\label{ex:}
\langinfo{}{}{  ‘Bob and Bill saw each other.’  (ID1377, 1379)}\\
\end{listWWviiiNumxlileveli}
...
\begin{listWWviiiNumxlileveli}
\item \ea\label{ex:}
\langinfo{}{}{[Warning: Draw object ignored]a. Lubukusu          b. Limbum}\\
\end{listWWviiiNumxlileveli}
...
\begin{listWWviiiNumxlileveli}
\item \ea\label{ex:}
\langinfo{}{}{a.  DP\-\textsubscript{antecedent}      V-RCM  DP\textsubscript{RCA    }\textbf{Lubukusu}}\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Chichewa}\\
\ea\label{ex:}
\langinfo{}{}{  [\textit{Aleje    á-ma-}\textbf{\textit{dzi}}\textit{{}-nyóz-á}]\textit{    ku-pósá   asodzi}\\
  \textsc{c}2-hunters   \textsc{c2-hab-}\textbf{\textsc{rfm}}{}-despise-\textsc{fv}   \textsc{inf}{}-exceed   \textsc{c}2-fisherman}\\
\ea\label{ex:}
\langinfo{}{}{  i.‘The hunters despise themselves more than the fisherman despise themselves.’                       \textit{sloppy}}\\
\ea\label{ex:}
\langinfo{}{}{\textit{  }ii. ‘The hunters despise themselves more than the fishermen despise them.’                            \textit{contrastive}}\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Chichewa  }\\
\ea\label{ex:}
\langinfo{}{}{  \textit{[Aleje     á-ma-nyóz-}\textbf{\textit{an}}\textit{{}-á   ]    ku-pósá   asodzi}}\\
\ea\label{ex:}
\langinfo{}{}{  \textsc{c}2-hunters   \textsc{c2-hab}{}-despise-\textbf{\textsc{rcm}}\textsc{{}-fv}     \textsc{inf}{}-exceed   \textsc{c}2-fisherman}\\
\ea\label{ex:}
\langinfo{}{}{  i. ‘The hunters despise each other more than the fisherman despise each other.'                         \textit{sloppy}  }\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Lubukusu}\\
\ea\label{ex:}
\langinfo{}{}{  \textit{[ba-saani   ba-a-biyil-}\textbf{\textit{an}}\textit{{}-a ]   khu-khil-a   ba-khasi}}\\
\ea\label{ex:}
\langinfo{}{}{  \textsc{c}2-man   \textsc{c2-pst}{}-hate-\textbf{\textsc{rcm}}\textsc{{}-fv}   \textsc{c}15-defeat-\textsc{fv}   \textsc{c}2-woman  }\\
\ea\label{ex:}
\langinfo{}{}{  i. 'The men hate each other more than the women hate each other.'  \textit{sloppy}}\\
\ea\label{ex:}
\langinfo{}{}{\textit{  }ii. 'The men hate each other more than the women hate the men.'  \textit{contrastive}                       (ID5036)}\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Lubukusu  }\\
\ea\label{ex:}
\langinfo{}{}{  \textit{Naanu  ni-ye    ba-saani   ba-a-pa   lukali}?}\\
\ea\label{ex:}
\langinfo{}{}{  who  that-\textsc{agr}   \textsc{c}2-man   \textsc{c}2-\textsc{tns}{}-beat   fiercely}\\
\ea\label{ex:}
\langinfo{}{}{  ‘Who did the men beat fiercely?’}\\
\end{listWWviiiNumxlileveli}
\begin{listWWviiiNumxlileveli}
\ea\label{ex:}
\langinfo{}{}{  \textit{A1:  Ba-saani  ba-a-pa  }\textbf{\textit{Yohana}}\textit{  lukali   }  (DO-Adverb)}\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Lubukusu  }\\
\ea\label{ex:}
\langinfo{}{}{  \textit{Wahena  ni-yo    Yohana  a-a-kona  bwangu}}\\
\ea\label{ex:}
\langinfo{}{}{  where     that-\textsc{agr}   John     \textsc{c1-tns}{}-sleep  quickly}\\
\ea\label{ex:}
\langinfo{}{}{  ‘Where did John sleep quickly?’}\\
\ea\label{ex:}
\langinfo{}{}{  A1:  \textit{Yohana  a-kona    }\textbf{\textit{mu-sikuri}}\textit{   bwangu  }(PP adj-Adverb)}\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Lubukusu}\\
\ea\label{ex:}
\langinfo{}{}{  \textit{Wahena  ni-yo    Yohana   a-a-ra     si-tabu          bwangu}}\\
\ea\label{ex:}
\langinfo{}{}{  where     that-\textsc{agr}   John     \textsc{c1-tns}{}-put   \textsc{c}7-book       quickly}\\
\ea\label{ex:}
\langinfo{}{}{  ‘Where did John put the book quickly?’  }\\
\end{listWWviiiNumxlileveli}
\begin{listWWviiiNumxlileveli}
\ea\label{ex:}
\langinfo{}{}{  A1:  \textit{Yohana    a-a-ra  si-tabu    }\textbf{\textit{khu-mesa}}\textit{  bwangu    } (PP arg-Adverb)}\\
\end{listWWviiiNumxlileveli}
...
\begin{listWWviiiNumxlileveli}
\ea\label{ex:}
\langinfo{}{}{  A1:  \textit{ba-saani   ba-rum-ir-a    }\textbf{\textit{Maria}}\textit{     bi-tabu    }   (IO-DO) }\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Lubukusu}\\
\ea\label{ex:}
\langinfo{}{}{  \textit{Naanu  ni-ye     ba-saani   ba-fumi-a   lukali}}\\
\ea\label{ex:}
\langinfo{}{}{  who   that-\textsc{agr}  \textsc{c}2-men   \textsc{c}2-praise-\textsc{fv}   fiercely}\\
\ea\label{ex:}
\langinfo{}{}{  ‘Who did the men praise fiercely?’}\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Lubukusu  }\\
\ea\label{ex:}
\langinfo{}{}{  a.  \textit{ba-saani  ba-rum-ir-an-a    }\textbf{\textit{ba-be-ene  khu be-ene}}\textit{  } bi-tabu      \textsc{c}2-men   \textsc{c2.tns}{}-send-\textsc{appl-rcm-fv}     \textsc{c2-c2}{}-own on   \textsc{c}2-own   \textsc{c}8-book       }\\
\end{listWWviiiNumxlileveli}
\setcounter{listWWviiiNumxixleveli}{0}
\begin{listWWviiiNumxixleveli}
\begin{styleExample}
...
\langinfo{}{}{Lubukusu}\\
\ea\label{ex:}
\langinfo{}{}{  a.\textit{  o-mu-ndu        ne   e-m-bwa  }\textbf{\textit{bi}}\textit{{}-a-rekukh-a }}\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Lubukusu  }\\
\ea\label{ex:}
\langinfo{}{}{  a.  \textit{o-mu-hayi   ne   e-twika   bi-a-bon-}\textbf{\textit{an}}\textit{{}-a  }}\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Lubukusu  }\\
\ea\label{ex:}
\langinfo{}{}{  \textit{a.  o-mu-hayi   ne   e-twika   bi-a-}\textbf{\textit{i}}\textit{{}-bon-a  }}\\
\end{listWWviiiNumxlileveli}
...
\langinfo{}{}{Lubukusu  }\\
\ea\label{ex:}
\langinfo{}{}{  \textit{ba-khasi   ba-a-}\textbf{\textit{i}}\textit{{}-yeet-}\textbf{\textit{an}}\textit{{}-a     (ba-b-eene khu ba-b-eene)}}\\
\ea\label{ex:}
\langinfo{}{}{  \textsc{c}2-woman   \textsc{c2-pst-}\textbf{\textsc{rfm}}{}-help-\textbf{\textsc{rcm}}\textsc{{}-fv}   \textsc{c2-c}2-own on  \textsc{c2-c2}{}-own}\\
\ea\label{ex:}
\langinfo{}{}{  ‘The women helped each other and themselves.’ (ID1533)}\\
\end{listWWviiiNumxlileveli}
