...
\todo{suggest adding the ID.... identifiers as third argument of langinfo. [No, some IDs vary across subexx of a single langinfo block -DP]}
\ea\label{ex:safir:2}
\langinfo{{Yoruba}}{}{} \\
...
\begin{forest} begin draw/.append code={[baseline=(CP-phase.base)]}
[vP
...
\begin{forest} for tree={align=center,base=top},  begin draw/.append code={[baseline=(CP-phase.base)]}
	[vP
	[DP\textsubscript{antecedent}] [v'
...
\begin{forest} for tree={base=top},  begin draw/.append code={[baseline=(CP-phase.base)]}
	[vP
	[DP\textsubscript{antecedent}] [v'
	[v-RCM\\ \relax {[+reciprocal]}] [VP
	[V] [ANA]
