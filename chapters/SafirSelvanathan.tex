...
\ea\label{ex:}
\langinfo{}{}{Gungbe} \\
\gll Náwè     lɔ  lɛ  ná  hù}  \textbf{\textit{yé-ɖé} \\
...
\ea\label{ex:}
\langinfo{}{}{{Fe’efe’e}} \\
\gll \textit{pʉ-nʒw\={i}ɛ   lɒfɛn}}     {\textbf{\textit{n\={a}   jɒɒ}}} \\
\gll \textsc{c}}{2-woman}   {\textsc{pst2}}{-sell   body}   {\textsc{poss.det.c1}}\\
...
\langinfo{}{}{Urhobo} \\
\ea\label{ex:}
\gll \textit{ayen   mrẹ}     \textbf{\textit{ohwo-ohwo}} \\
       they   see.\textsc{pst}   person-person \\
\glt   ‘They saw themselves/ each other.’ (ID2874)
\z
\ex
\gll emo    na  fa    \textbf{\textit{oma-oma-rẹ-ayen}}\\
...
\ea\label{ex:}
\langinfo{}{}{Limbum}\\
\gll Wèe  tʉr  à  rjà’-*(\textbf{\textit{se})    \textbf{{mnyor}} \\
...
\ea\label{ex:}
\glll
DP\-\textsubscript{antecedent}      V-RCM  DP\textsubscript{RCA}    \textbf{Lubukusu}}\\
...
\ea\label{ex:}
\langinfo{}{}{Lubukusu}\\
\glt \textit{[ba-saani   ba-a-biyil-}\textbf{\textit{an}}\textit{-a ]   khu-khil-a   ba-khasi}} \\
...
\ea\label{ex:}
\langinfo{}{}{Lubukusu}  \\
\textit{Naanu  ni-ye    ba-saani   ba-a-pa   lukali}? \\
...
\ea\label{ex:}
\gll \textit{A1:  Ba-saani  ba-a-pa}  \textbf{\textit{Yohana}}\textit{  lukali}     (DO-Adverb)} \\
...
\ea\label{ex:}
\langinfo{}{}{Lubukusu}  \\
\gll \textit{Wahena  ni-yo    Yohana  a-a-kona  bwangu}} \\
where     that-\textsc{agr}   John     \textsc{c1-tns}-sleep  quickly} \\
\glt ‘Where did John sleep quickly?’ \\
\z

\ea\label{ex:}
\gll A1:  \textit{Yohana  a-kona}    \textbf{\textit{mu-sikuri}}\textit{   bwangu}  (PP adj-Adverb)} \\
...
\ea\label{ex:}
\langinfo{}{}{Lubukusu}\\
\gll \textit{Wahena  ni-yo    Yohana   a-a-ra     si-tabu          bwangu} \\
...
\ea\label{ex:}
\gll A1:  \textit{Yohana    a-a-ra  si-tabu}    \textbf{\textit{khu-mesa}}\textit{  bwangu}     (PP arg-Adverb)} \\
...
\ea\label{ex:}
\gll A1:  \textit{ba-saani   ba-rum-ir-a}    \textbf{\textit{Maria}}\textit{     bi-tabu}       (IO-DO)} \\
...
\ea\label{ex:}
\langinfo{}{}{Lubukusu}\\
\gll \textit{Naanu  ni-ye     ba-saani   ba-fumi-a   lukali}} \\
...
\langinfo{}{}{Lubukusu}  \\
\ea
\gll  \textit{ba-saani  ba-rum-ir-an-a}    \textbf{\textit{ba-be-ene  khu be-ene}}  bi-tabu      \\
...
\ex
\gll  \#\textit{ba-saani   ba-rum-ir-an-a~  bi-tabu}   \textbf{\textit{ba-be-ene khu be-ene}}\\ 
\glt                      (DO-RCA)
\\
...
\langinfo{}{}{Lubukusu}\\
\ea
\gll \textit{  o-mu-ndu        ne   e-m-bwa}  \textbf{\textit{bi}}\textit{-a-rekukh-a} \\
       \textsc{c1-c1}-person   and  \textsc{c9-c9}-dog   \textbf{\textsc{c}}\textbf{8}-\textsc{pst}-leave-\textsc{fv} \\
\glt   ‘The man and the dog left.’

\ex
\gll \textit{  e-m-bwa}  \textbf{\textit{yi}}\textit{-a-rekukh-a     ne   o-mu-ndu}
...
\langinfo{}{}{Lubukusu}  \\
\ea
\gll  \textit{o-mu-hayi   ne   e-twika   bi-a-bon-}\textbf{\textit{an}}\textit{-a}}  \\
...
\langinfo{}{}{Lubukusu}  \\
\ea
\gll  o-mu-hayi   ne   e-twika   bi-a-}\textbf{\textit{i}}\textit{-bon-a}}  \\
...
\ea\label{ex:}
\langinfo{}{}{Lubukusu}  \\
\gll \textit{ba-khasi   ba-a-}\textbf{\textit{i}}\textit{-yeet-}\textbf{\textit{an}}\textit{-a     (ba-b-eene khu ba-b-eene)}} \\
