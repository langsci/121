...
\todo{Please check the Talmy1985 references. There are two 1985 works by Talmy, and I would not know which one is intended}
...
\lspbottomrule
\end{tabularx}
\todo[inline]{Table 2: in 2nd column "TB", "TG", "TL", "ABGT" etc. need to be under the descriptive label for rows 1a through 2c. Align table better.}
\end{table}
