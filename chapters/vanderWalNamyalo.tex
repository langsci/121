...
\ex  Yagúlírá {\longrule}-báana ebitábó             \jambox{\textup{[-A, +A]}}
\glt   ‘He bought \textsc{the children} books.’           
\ex  *Yagúlira a-báana {\longrule}bitábó            \jambox{\textup{[+A, -A]}}
\glt   (‘He bought the children \textsc{books}.’)           
\ex   {Yagúlírá {\longrule}-báana {\longrule}-bitábó}            \jambox{\textup{[-A, -A]}}
\glt  ‘He bought \textsc{the children books}.’ (Hyman and Katamba 1993: 228-229)
\z
\z
...
For completeness we mention that the agent NP in a passive can be [-A] as well, and as expected it triggers the exclusive interpretation \REF{ex:vanderwal:38}. The agent does not need a preposition ‘by’ in Luganda (see \citealt{Pak2008}).
