...
\begin{itemize}
\item \begin{styleNumberedEX}
\label{bkm:Ref424142726}m\`{a}m    p????-\`{a}         p\'{a}g-\~{a}\`{ }      w\'{e}\'{e}-f-\`{a}
\end{styleNumberedEX}\end{itemize}
\begin{styleGloss}
...
\begin{itemize}
\item \begin{styleNumberedEX}
\label{bkm:Ref424142734}m\`{a}m    r??lg-\`{a}      b????-s-\'{a}    n\`{a}ng\`{u}-r\'{i}
\end{styleNumberedEX}\end{itemize}
\begin{styleGloss}
...
\begin{itemize}
\item \begin{styleNumberedEX}
\label{bkm:Ref424317802}*m\`{a}m    t\'{o}\'{o}l-\`{a}    z\'{a}\`{a}m??    p\'{a}g-\~{a}\`{ }      r\'{u}-k\~{a}\`{ }
\end{styleNumberedEX}\end{itemize}
\begin{styleGloss}
...
\begin{itemize}
\item \begin{styleNumberedEX}
\label{bkm:Ref424317812}*m\`{a}m    t\'{o}\'{o}l-\`{a}    p\'{a}g-\~{a}\`{ }      z\'{a}\`{a}m??    r\'{u}-k\~{a}\`{ }
\end{styleNumberedEX}\end{itemize}
\begin{styleGloss}
...
\begin{itemize}
\item \begin{styleNumberedEX}
\label{bkm:Ref424233046}p\'{a}g    l\'{a}nn\'{i}ng\`{a}  \'{a}    M\'{u}s\'{a}  h??\'{ }    t\'{o}\'{o}l  r\'{u}-k\~{a}\`{ }
\end{styleNumberedEX}\end{itemize}
\begin{styleGloss}
...
\begin{itemize}
\item \begin{styleNumberedEX}
\label{bkm:Ref424233055}r\'{u}-k    l\'{a}nn\'{i}ng\`{a}  \'{a}    M\'{u}s\'{a}  h??\'{ }    t\'{o}\'{o}l  p\'{a}g-\~{a}\`{ }
\end{styleNumberedEX}\end{itemize}
\begin{styleGloss}
...
\begin{itemize}
\item \begin{styleNumberedEX}
\label{bkm:Ref424287194}\`{a}    Ou\'{e}rm\'{i}  n??  M\'{u}s\'{a}  w\'{i}n\'{i}g-\`{a}  t\'{a}\'{a}b    b\'{a}\'{a}-g\~{a}\`{ }
\end{styleNumberedEX}\end{itemize}
\begin{styleGloss}
...
\begin{itemize}
\item \begin{styleNumberedEX}
\label{bkm:Ref424287203}\`{a}    Ou\'{e}rm\'{i}  n??  M\'{u}s\'{a}  w\'{i}n\'{i}g-\`{a}  t\'{a}\'{a}b    \`{a}    Al\'{i}
\end{styleNumberedEX}\end{itemize}
\begin{styleGloss}
