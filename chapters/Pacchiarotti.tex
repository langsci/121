...
\label{fig:1.pacchiarotti}
    \todo[inline]{should these two figures not be examples 19 and 20?}
\end{figure}
...
For 1\textsc{pl}, 2\textsc{pl} and 3\textsc{pl}, a pronoun form from set I is used \textit{if} another NP, including one functioning as O\textsubscript{T}, an oblique, or an adverb follows (\figref{fig:2.pacchiarotti}). Using a set II pronoun form for the first linear object in \figref{fig:2.pacchiarotti} would result in ungrammaticality.
...
\frame{\begin{tabular}{lllll}
		...
		\oldstylenums{3}\textsc{sg.i} & give-\textsc{aff} & \textit{y\'{\~a}mb bámb} &  scarf-\textsc{cl}\oldstylenums{5} &  red-\textsc{cl}\oldstylenums{12}-\textsc{idn}\\
		\multicolumn{5}{l}{`He gave \{us, you, all, them\} a red scarf.´}
\end{tabular}}
