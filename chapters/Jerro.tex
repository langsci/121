...
Juma {\sc 1S-pst}-wear-{\sc appl-fv} kanzu\\
	\glt Intended: `Juma was wearing a Kanzu.' (Marten 2003: 9) %\REF{ex:jerro:14}
	\end{xlist}
\end{exe}
%
...
% It needs to be motivated that the non-applied goal is actually a goal, with tests on \REF{ex:jerro:1} whether ``John" in \REF{ex:jerro:16b} can be inanimate, and \REF{ex:jerro:2} whether it can be denied that the subject still has the ball. 
