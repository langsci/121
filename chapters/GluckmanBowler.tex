...
%Thank you for working to better explain your terminology and approach. At the same time, we now find some statements in the revised footnote still confusing and/or too cryptic. So we suggest you leave out the parts on labile verbs (which we find raises even more questions about your approach and definitions), and inchoative from this brief footnote. Regarding your last sentence, this may be the state{}-of{}-the art within a Distributed Morphology or “layered” or Minimalist approach, but not all theoretical approaches adopt this. Hence, we suggest adding “within a Distributed Morphology approach” (which we understand is what Schafer \& Alexiadou are following).
%
...
%I think it is very important that you specify somewhere that you use the terms transitive and intransitive to mean SYNTACTICALLY (not semantically) transitive and intransitive (verbs). 
%
...
%I suggest you put this information at the beginning of footnote 6. 
%

\begin{styleTabellenberschrift}%%please move \begin{table} just above \begin{tabular
\begin{table}
\caption{Intransitive verb classes in Luragooli and based on the distribution of {}-Vk%}
\label{tab:1}
\end{table}%I feel that ‘and the distribution of –Vk’ is disconnected from the rest of the title of the table. How about “intransitive verb classes in Luragooli based on the distribution of –Vk”? 
...
%As a reader, I would like to know if any or all verbs in Class II can occur ONLY in a syntactically intransitive construction with one single core argument. If so, then the verbs in class II are syntactically intransitive at the root level?  (Or do you mean that members of this group are ‘labile’?)
...
\chapter[3. The distribution of {}-Vk in Luragooli]{3. The distribution of \textit{{}-}\textit{Vk} in Luragooli}

The suffix \textit{{}-}\textit{Vk} attaches to certain transitive (causative) verbs %
%syntactically transitive? Semantically transitive? 
%
...
%There are two different spellings of ‘door’
%muriaŋgo
%murianggo
%Is it a typo? Or is it because of the grammatical relation it carries in 4 vs. 5a and 5b?
%
.    causative\\
...
%In footnote 2, you say you will use the term ‘unmarked intransitive’ for (I assume syntactically) intransitive verb forms which do not take the –Vk suffix. Here I see ‘plain intransitive’. Are these synonyms? The proliferation of terminology is confusing. 
%\\
...
%I think this can be omitted as plain form is a very vague term which is not self{}-explanatory and can confuse readers. 
%
...
%We are already in section 3. This should probably go before section 3 starts. Also, please be even more specific. \sectref{sec:3} deals with theta{}-roles and section 4 with lexical aspect in relation to the –Vk suffix. 
%
...
%The parenthetical remark seems odd in the main text; we suggest you include it in footnote 8.
%
...
%The parenthetical information is best placed in a footnote – as we have done here.
%
...
%It seems pretty obvious that Anticausatives are change{}-of{}-state oriented, which correlates with telicity. 
%
%(Antipassives, on the other hand, tend to be more agent oriented [again, with some typological exceptions{]}; so we might not expect such a telicity restriction on antipassives.)
%
...
%This seems redundant by now. Can it be omitted?
%
...
\label{tab:4}
\end{table}%I find this title confusing. Why not simply Verb forms of classes Ia and Ib? Or something similar?
%\end{styleTabellenberschrift}
...
%Can verbs in Class Ib also occur with an oblique demoted subject?
%
...
%Comment from reviewer: “Songs are created by the action of singing, a song in sing a song is often called a cognate object.”
%
%We find this comment puzzling and are not sure how to respond. It’s not at all clear to us how cognate objects are relevant to our discussion. Moreover, the comment appears to underline our point: verbs of creation (as you seem to be classifying sing) are distinct from the “affected{}-argument” class we are describing. In any event, since we are speaking speculatively at this point, and since we do not have a great deal of space, we don’t think it’s necessary to include a discussion of additional verb classes here.
%
%
%
%
%I apologize if my comment was not clear. I never wanted to say that you should discuss cognate objects in this paper. By bringing about ‘cognate objects’ I only meant to say that it seems evident to me that songs are not ‘affected’ by the action of singing, because they come to existence through singing. To be honest, however, my problem is that it is not quite clear to me what “affected” really means (or wants to mean) in linguistics.
%
...
%Granted the English translations in the table can be ambiguous – but at least one sense of the English translations ‘to touch’ and ‘to lick’ are agentive. cf. I touched him on purpose. Lick your ice{}-cream cone!
%
...
%How about: ‘since in depth work on anticausatives has been done mostly for western languages? Now, by western languages, do you mean western European languages? Please specify. 
%
