...
\gll  Sira a-han-i       muriaŋgo.\\
       Sira 1-close-\textsc{fv} 3door\\ \jambox{\textsc{(lexical) causative}}
       }
...
\textbf{Class II}\newline (\small intransitive without \textit{-Vk}) & 
\textbf{Class III}\newline (\small intransitive with or without \textit{-Vk})\\
\midrule
