...
\footnotetext{According to \citet{Duarte2011}, the particle \textit{a} occurs only in some dialectical varieties of Changana and Rhonga. When it precedes a DP object, its major role is to encode definiteness and indicate that the referent of that object has already been given in previous discourse. } 
