...
\chapter[Palauan \citep[30]{Georgopoulos1991}]{Palauan \textstyleFontepargpadroi{\citep[30]{Georgopoulos1991}}}
...
\end{itemize}
     \textsc{3}\textstyleFontepargpadroi{\textsc{pl}}\textsc{{}-}\textstyleFontepargpadroi{\textsc{prf}}.hit         dog             children\\
\glt ‘The children hit a dog/some dogs.’
\z

\chapter[]{\rmfamily }

In addition to verbal agreement, other strategies are also found across languages to convey semantic differences among objects. \citet{Danon2002}, for instance, shows that in Hebrew the case particle \textstyleFontepargpadroi{\textit{et}} is obligatorily triggered whenever the object is definite, as in (3).
...
\end{itemize}
     Dan       read       \textstyleFontepargpadroi{\textsc{acc     def}}{}-book\\
...
Sentence (3b) is ungrammatical because the definite object \textstyleFontepargpadroi{\textit{ha-sefer}} ‘the book’ must be preceded by the case marker \textstyleFontepargpadroi{\textit{et}}. Nonetheless, if the object is indefinite, this case marker cannot appear. Compare (4a-b):
...
\end{itemize}
     Dan          read        \textstyleFontepargpadroi{\textsc{acc}}\textstyleFontepargpadroi{   }book\\
\glt (‘Dan reads a book.’)
\z
...
\end{itemize}
     1.man                    1.\textstyleFontepargpadroi{\textsc{sm}}\textsc{{}-}\textstyleFontepargpadroi{\textsc{pst}}\textsc{{}-1.}\textstyleFontepargpadroi{\textsc{om}}{}-see-\textstyleFontepargpadroi{\textsc{fv}}     1.boy\\
...
\end{itemize}
     1.man                    1.\textstyleFontepargpadroi{\textsc{sm}}\textsc{{}-}\textstyleFontepargpadroi{\textsc{pst}}{}-see-\textstyleFontepargpadroi{\textsc{fv}}              1.boy\\
\glt (‘The man has seen the boy.’)
\z
...
\end{itemize}
     \textstyleFontepargpadroi{1.man                   1.}\textstyleFontepargpadroi{\textsc{sm-pst}}\textstyleFontepargpadroi{{}-2.om-see-}\textstyleFontepargpadroi{\textsc{fv}}\textstyleFontepargpadroi{      2.cat}\\
...
\end{itemize}
     \textstyleFontepargpadroi{1.man                    1}\textstyleFontepargpadroi{\textsc{.sm-pst}}\textstyleFontepargpadroi{{}-see-}\textstyleFontepargpadroi{\textsc{fv}}\textstyleFontepargpadroi{             2.cat}\\
\glt (‘The man has seen the cats.’)
\z
...
\end{itemize}
     \textstyleFontepargpadroi{1.man                  }\textstyleFontepargpadroi{\textsc{1.sm-pst}}\textstyleFontepargpadroi{{}-see-}\textstyleFontepargpadroi{\textsc{fv}}\textstyleFontepargpadroi{            3.rat}\\
...
\end{itemize}
     \textstyleFontepargpadroi{1.man                  1.}\textstyleFontepargpadroi{\textsc{sm-pst}}\textstyleFontepargpadroi{{}-3.}\textstyleFontepargpadroi{\textsc{om-}}\textstyleFontepargpadroi{see}\textstyleFontepargpadroi{\textsc{{}-fv}}\textstyleFontepargpadroi{         3.rat}\\
...
\end{itemize}
     \textstyleFontepargpadroi{1.man                 }\textstyleFontepargpadroi{\textsc{1.sm-pst}}\textstyleFontepargpadroi{{}-see-}\textstyleFontepargpadroi{\textsc{fv}}\textstyleFontepargpadroi{           5.giraffe}\\
...
\end{itemize}
     \textstyleFontepargpadroi{1.man                  1}\textstyleFontepargpadroi{\textsc{.sm-pst}}\textstyleFontepargpadroi{{}-5.}\textstyleFontepargpadroi{\textsc{om}}\textstyleFontepargpadroi{{}-see-}\textstyleFontepargpadroi{\textsc{fv}}\textstyleFontepargpadroi{        5.giraffe}\\
...
\end{itemize}
     \textstyleFontepargpadroi{1.man                   1.}\textstyleFontepargpadroi{\textsc{sm-pst}}\textstyleFontepargpadroi{{}-see-}\textstyleFontepargpadroi{\textsc{fv}}\textstyleFontepargpadroi{               7.pig}\\
...
\end{itemize}
     \textstyleFontepargpadroi{1.man                   1.}\textstyleFontepargpadroi{\textsc{sm-pst}}\textstyleFontepargpadroi{{}-7.}\textstyleFontepargpadroi{\textsc{om}}\textstyleFontepargpadroi{{}-see-}\textstyleFontepargpadroi{\textsc{fv}}\textstyleFontepargpadroi{          7.pig}\\
...
\textstyleFontepargpadroi{Shimakonde differs from Emakhuwa due to the fact that Shimakonde object marking is not limited to classes 1 and 2, which generally include [+}\textstyleFontepargpadroi{\textsc{human}}\textstyleFontepargpadroi{, +}\textstyleFontepargpadroi{\textsc{animate}}\textstyleFontepargpadroi{] nouns, but is also extended to animate nouns of other classes, such as singular classes 5, 7, and 9 and their plural counterparts.}\textstyleFontepargpadroi{ For the most part, }\textstyleFontepargpadroi{the singular forms in these classes take the nominal class prefixes \{}\textstyleFontepargpadroi{\textit{li-}}\textstyleFontepargpadroi{\}, \{}\textstyleFontepargpadroi{\textit{shi-}}\textstyleFontepargpadroi{\} and \{}\textstyleFontepargpadroi{\textit{(i)N-}}\textstyleFontepargpadroi{\} and the plural forms take \{}\textstyleFontepargpadroi{\textit{ma-}}\textstyleFontepargpadroi{\}, \{}\textstyleFontepargpadroi{\textit{vi-}}\textstyleFontepargpadroi{\}, \{}\textstyleFontepargpadroi{\textit{di-}}\textstyleFontepargpadroi{\}, respectively. The only exception is nouns of class 10 that can take either the prefix \{di-\} or the prefix \{va-\}, as shown in the end of \tabref{tab:2}. }\textstyleFontepargpadroi{It is important to point out that}\textstyleFontepargpadroi{ in these classes there are both [-}\textstyleFontepargpadroi{\textsc{animate, -human}}\textstyleFontepargpadroi{] and [+}\textstyleFontepargpadroi{\textsc{animate, -human}}\textstyleFontepargpadroi{] nouns. Compare the data in Tables 1 and 2.}
...
\textstyleFontepargpadroi{\textmd{\tabref{tab:2}: }}Emakhuwa: [-human, +animate] nouns of classes 5, 7, and 9
...
{\mdseries (Plural)}\\
 ...
 \textit{imbudi}\par & ‘dog’\par

 ‘fly’\par

 ‘goat’\par & \textit{di-ng’avanga}\par

 \textit{di-namembe}\par

 \textit{di-mbudi}\par & \textit{vang’vanga}\par
...
\lspbottomrule
\end{tabularx}
\textstyleFontepargpadroi{In Shimakonde, any animate object DP, regardless of the class prefix that the noun itself has, can be referenced in the verb by }\textstyleFontepargpadroi{\textit{m(V)- }}\textstyleFontepargpadroi{‘singular class 1’ and }\textstyleFontepargpadroi{\textit{va-}}\textstyleFontepargpadroi{ ‘plural class 2’. }\textstyleFontepargpadroi{The morphological distribution of the object prefixes }\textstyleFontepargpadroi{\{}\textstyleFontepargpadroi{\textit{mu}}\textstyleFontepargpadroi{{}- {\textasciitilde} }\textstyleFontepargpadroi{\textit{m}}\textstyleFontepargpadroi{{}- {\textasciitilde} }\textstyleFontepargpadroi{\textit{n}}\textstyleFontepargpadroi{{}-\} and \{}\textstyleFontepargpadroi{\textit{va-}}\textstyleFontepargpadroi{\} that occur on the verb }\textstyleFontepargpadroi{can be understood by the examples in }(9)\textstyleFontepargpadroi{ and }(10)\textstyleFontepargpadroi{. It is important to point out that t}hese animate object markers occur in the verb, regardless of the class of the noun. \textstyleFontepargpadroi{If the object prefix does not appear in the verbal complex when the object DP is animate, the sentence becomes ungrammatical, as shown in }(9)\textstyleFontepargpadroi{ and }(10)\textstyleFontepargpadroi{.}
...
Examples (9)\textstyleFontepargpadroi{ and }(10)\textstyleFontepargpadroi{ }illustrate these facts for nouns of classes 1 and 2. But in addition to objects of class 1 and class 2, the object markers are also extended to cross-reference animate nouns belonging to classes 5, 7 and 9. This thus signals that \textstyleFontepargpadroi{it is not noun class but animacy }that regulates DOM in Shimakonde. Notice that there is a mismatch in the glossing in (11) as the object prefix  \{\textstyleFontepargpadroi{\textit{n-}}\} that appears on the verb stems is of class 1, whereas the DP objects belong to classes 5 and 7, respectively. To explain this mismatch one might assume that \{\textstyleFontepargpadroi{\textit{mu}}{}- {\textasciitilde} \textstyleFontepargpadroi{\textit{m}}{}- {\textasciitilde} \textstyleFontepargpadroi{\textit{n}}{}-\} ‘singular’ and \{\textit{va-}\} ‘plural’ have become specialized as differential object markers to indicate animacy in Shimakonde, regardless of whether the object belongs to the (singular) classes 1, 5, 7 or 9.
...
Nonetheless, the object prefix \{\textstyleFontepargpadroi{\textit{n-}}\} is omitted when the animate object referent is indefinite and not given in the previous discourse. This indicates that the occurrence of this prefix is regulated not only by animacy but also by the definiteness property of DP objects that belong to nouns of classes 5, 7 and 9, as comparison of (11a-c) and (14a-c) shows.
...
\textstyleFontepargpadroi{In conclusion, the examples in }(14)\textstyleFontepargpadroi{ demonstrate that when the object prefix is absent the referent of the DP object must be interpreted as indefinite, whereas the presence of the prefix entails that the object constitutes given information in discourse. }\textstyleFontepargpadroi{An alternative way to encode definiteness of the referents of inanimate nouns of classes 5, 7 and 9 is by placing modifiers after the noun, such as the demonstrative \{}\textstyleFontepargpadroi{\textit{a-}}\textstyleFontepargpadroi{\}}\textstyleFontepargpadroi{\textit{ }}\textstyleFontepargpadroi{‘this’. This strategy is illustrated with the demonstratives }\textstyleFontepargpadroi{\textit{a-li }}\textstyleFontepargpadroi{and}\textstyleFontepargpadroi{\textit{ a-shi}}\textstyleFontepargpadroi{ in }(15)\textstyleFontepargpadroi{.}

\chapter[Shimakonde]{\textstyleFontepargpadroi{Shimakonde}}
\label{bkm:Ref455884826}\setcounter{itemize}{0}
\begin{itemize}
\item \gll ngw-on-ile               lijanga        a-li\\
\end{itemize}
...
\begin{itemize}
\item \gll nangu      ni-ndy-on-a                shijiko         a-shi\\
\end{itemize}
     I              \textsc{1sg.sm-pst}{}-see-\textsc{vf }     7.spoon       this-7\\
\glt ‘I saw this spoon (a definite one).’
\z

\textstyleFontepargpadroi{Based on these data, one may postulate that the differential object mar}\textstyleFontepargpadroi{king in Shimakonde is mainly regulated by a more complex set of criteria than in }\textstyleFontepargpadroi{Emakhuwa}\textstyleFontepargpadroi{. In Shimakonde the agreement prefix is obligatory if it refers to animate nouns of classes 1 and 2, whereas when it cross-references nouns of classes 5, 7 and 9, the object is both animate and definite. }\textstyleFontepargpadroi{The Shimakonde data require us to postulate a slightly different generalization from the one proposed by Liphola (2001}\textstyleFontepargpadroi{: 23), who says “verbs in Shimakonde only take OPs (object prefixes) of classes 1 and 2, which have a feature [+}\textstyleFontepargpadroi{\textsc{animate}}\textstyleFontepargpadroi{]”. Instead, Liphola’s analysis must be refined to state that the Shimakonde object prefix agrees with DP objects of class 1 and 2 and may agree with DP objects of classes 5, 7 and 9 that carry the semantic features }\textstyleFontepargpadroi{\textsc{[+animate, +human, +definite], }}\emph{\textup{as shown in \tabref{tab:2}.}}

\section{ 4. DOM in Rhonga and Changana}
...
\chapter[Changana and Rhonga DOM: Object agreement in the verb is possible but structurally optional if the object is definite/specific. It is forbidden if the object is indefinite/non{}-specific.]{Changana and Rhonga DOM: Object agreement in the verb is possible but structurally optional if the object is definite/specific. It is forbidden if the object is indefinite/non-specific.}
     \textstyleFontepargpadroi{As a preliminary illustration of first part of this generalization, consider }(17)\textstyleFontepargpadroi{ below, which was taken from a narration of the pear story film (Chafe, 1975).}\footnote{\textstyleTextodenotaderodapChar{ The six-minute film made at the University of California at Berkeley in 1975 can be downloaded at }\url{http://www.linguistics.ucsb.edu/faculty/chafe/pearfilm.htm}\textstyleTextodenotaderodapChar{.}}\textstyleFontepargpadroi{ In this narrative, the noun phrase }\textstyleFontepargpadroi{\textit{mufana}}\textstyleFontepargpadroi{ ‘boyʼ, which is introduced as the head of the relative clause in (17a), is cross-referenced as object on the verbs in (17c, e) by means of the class 1 object prefix \{}\textstyleFontepargpadroi{\textit{mu-}}\textstyleFontepargpadroi{\}. Notice that the main function of the object agreement prefix in this discourse section is to keep the reader updated about the}\textstyleFontepargpadroi{ }\textstyleFontepargpadroi{main topic of the discourse. In contrast to (17c) and (17e), no object marker occurs on the transitive verbs in (17b) and (17d), even though ‘his hatʼ (17b) and ‘that hatʼ (17d) are presumably definite/specific.}\\
...
\begin{itemize}
\item \gll na-\textbf{mu}{}-tiv-a                            a\footnote{\textstyleTextodenotaderodapChar{ The particle }\textstyleTextodenotaderodapChar{a}\textstyleTextodenotaderodapChar{ occurs only in some dialectical varieties of Changana and Rhonga. When it precedes a DP object, its major role is to encode definiteness and indicate that the referent of that object has already been given in previous discourse. }}        \textbf{mufana}\\
\end{itemize}
...
Given these background assumptions, we will assume, hereafter, that Rhonga and Changana set “yes” to Baker’s Directionality of Agreement Parameter (23). Notice that “F” can be read as the little \textit{v}\textsuperscript{o} that heads the \textstyleFontepargpadroi{\textit{v}}P projection in \figref{fig:2}.
...
\textstyleFontepargpadroi{\textit{F agrees with D/NP only if D/NP asymmetrically c-commands F.}}

This syntactic analysis entails that the head \textstyleFontepargpadroi{\textit{v}} searches upward for the theme object to agree with, not downward. This accounts for why DP objects must move to Spec-\textstyleFontepargpadroi{\textit{v}}P, or even to a higher position such as to a topic position.
...
The fact that the object marker must occur in the embedded clause in (25) suggests that the lower verb must establish agreement first with the closest DP that is located in the little \textstyleFontepargpadroi{\textit{v}}\textstyleFontepargpadroi{\textsuperscript{o}} c-command domain. The fact that the object markers stay close to the lower verb is expected if they are agreement. If they were object clitics or incorporated pronouns, they would be able to attach to higher verbs in the structure. This proposal serves to reinforce the hypothesis that the object prefix is not an incorporated pronoun, but agreement, since there should be no object agreement on \textstyleFontepargpadroi{\textit{v}} unless the agreed-with NP occurs in an argument position, that is, in the structural position of  Spec, \textstyleFontepargpadroi{\textit{v}}P. Another piece of evidence in favor of this analysis comes from the fact that the object prefix cannot appear on the verb when it is in a passive voice, as in (26):
...
\textstyleFontepargpadroi{The d}ouble object constructions examined here all involve applicative constructions. \textstyleFontepargpadroi{In general, }the literature proposes a distinction between \textit{symmetrical} and \textit{asymmetrical} object languages (Bresnan \& Moshi 1990; Chimbutane 2002; Ngonyani \& Githinji 2006). The two types of languages are diagnosed by syntactic tests involving: (a) object order, (b) passivization, (c) object marking and (d) relativization. In general, in Bantu languages it is observed that the \textsc{goal} or applied object (\textsc{ao}) can occur before the direct (\textsc{theme} or base) object (\textsc{do}) and vice-versa in symmetrical object languages, while the \textsc{goal} or applied object must precede the \textsc{theme} or base object in asymmetrical object Bantu languages. Only the \textsc{goal}/applied object may be passivized in asymmetrical object languages, whereas both can be passivized in symmetrical object languages. Furthermore, either object may trigger the object prefix on the verb stem in symmetrical object languages, as opposed to asymmetrical object languages in which only the goal may be cross-referenced on the verb. Based on these three tests, Bresnan and \citet{Moshi1990} propose the typology in \tabref{tab:3} to differentiate both types of (Bantu) languages.
...
\begin{itemize}
\item \gll hahani       a-\textbf{va}{}-svek-el-a                       tihlampfi         \textbf{vapfumba}\\
\end{itemize}
...
\begin{itemize}
\item \gll \textbf{vapfumba}     va-svek-el-iw-a                       tihlampfi         (hi    hahani)\\
\end{itemize}
     2.guest          2.\textsc{sm-}cook-\textsc{appl-pass}{}-\textsc{fv}       10.fish              by    1.aunt\\
\glt ‘The guests are being cooked some fish (by my aunt).’
\z

\textstyleFontepargpadroi{In example (27b), the object agreement prefix \{}\textstyleFontepargpadroi{\textit{va-}}\textstyleFontepargpadroi{\} refers to the }\textstyleFontepargpadroi{\textsc{goal}}\textstyleFontepargpadroi{ object and emphasizes that it corresponds to given information in the discourse. Therefore the }\textstyleFontepargpadroi{\textsc{goal}}\textstyleFontepargpadroi{ object must be interpreted as definite and specific in such construction. As the }\textstyleFontepargpadroi{\textsc{theme}}\textstyleFontepargpadroi{ object carries new information in (27b), it must move around the }\textstyleFontepargpadroi{\textsc{goal}}\textstyleFontepargpadroi{ object to a dedicated focus position in the left periphery of the }\textstyleFontepargpadroi{\textit{v}}\textstyleFontepargpadroi{P}\textstyleFontepargpadroi{\textit{. }}\textstyleFontepargpadroi{Evidence that the }\textstyleFontepargpadroi{\textsc{theme}}\textstyleFontepargpadroi{ object really represents the contrastive focus comes from the fact that sentence (27b) denotes the semantic interpretation that ‘my aunt is cooking fish and not chicken for the guests’. This grammatical pattern is confirmed by the fact that the sentence becomes ungrammatical if the agreement prefix \{}\textstyleFontepargpadroi{\textit{va}}\textstyleFontepargpadroi{{}-\} occurs on the verb stem and the }\textstyleFontepargpadroi{\textsc{goal}}\textstyleFontepargpadroi{ object remains in its unmarked (i.e. immediately postverbal) position, thereby occupying a syntactic position before the }\textstyleFontepargpadroi{\textsc{theme}}\textstyleFontepargpadroi{ object, as }in (28):

\chapter[Changana]{Changana}
\label{bkm:Ref455885678}\gll *\textstyleFontepargpadroi{hahani       a-}\textstyleFontepargpadroi{\textbf{va}}\textstyleFontepargpadroi{{}-svek-el-a                        }\textstyleFontepargpadroi{\textbf{vapfumba}}\textstyleFontepargpadroi{         tihlampfi}\\
     1.aunt          1.\textstyleFontepargpadroi{\textsc{sm}}\textstyleFontepargpadroi{{}-2.}\textstyleFontepargpadroi{\textsc{om}}\textstyleFontepargpadroi{{}-}cook\textstyleFontepargpadroi{{}-}\textstyleFontepargpadroi{\textsc{appl}}\textstyleFontepargpadroi{{}-}\textstyleFontepargpadroi{\textsc{fv}}\textstyleFontepargpadroi{       }2.guest             \textstyleFontepargpadroi{10.}fish\\
...
In double object constructions, at least in \textstyleFontepargpadroi{asymmetrical object languages such as Rhonga and Changana,}\footnote{\textstyleTextodenotaderodapChar{ We refer the reader to Chimbutane’s (2002) arguments for Changana as an asymmetrical object language.}}\textstyleFontepargpadroi{ }the \textsc{theme} object is never cross-referenced on the verb. Let’s then assume that the agreement between the \textsc{goal} and the little \textstyleFontepargpadroi{\textit{v}} takes place at the moment when the lexical verb performs successive cyclic movement from V-to-Appl and then from Appl-to-\textstyleFontepargpadroi{\textit{v}}. Additionally, let’s postulate that this head movement operation is followed by the \textsc{goal} object shift from the specifier of ApplP to the specifier of \textstyleFontepargpadroi{\textit{v}}P. Under this view, the agreement between the applied object and the verb follows from the Directionality of Agreement Parameter, proposed in (23), according to which a head F (i.e. the little light verb) agrees with a DP only if that DP asymmetrically c-commands F. This proposal has the advantage of accounting for why only the applied (=\textsc{goal/beneficiary}) argument controls the agreement on the verb complex, whereas the \textsc{theme} argument cannot. In short, this analysis presupposes that both the verb and the applied object are in the same local domain at the moment that the agree operation takes place. The derivation proposed here entails that the sentence in (29) has the syntactic derivation shown in \figref{fig:4}. In this derivation, moving the \textsc{theme} object around the \textsc{goal} to Spec-\textstyleFontepargpadroi{\textit{v}}P would put it before the \textsc{goal} object and the verb, thereby yielding [\textsc{theme-goal}{}-Verb] word order. A way to restore the superficial [Verb-\textsc{theme-goal}] word order is to propose that the verb subsequently moves to the \textstyleFontepargpadroi{\textsc{infl}} node (Tense/Aspect/Mood domain) of the clause, as depicted by the derivation in \figref{fig:4}.

\chapter[Changana]{Changana}
\label{bkm:Ref455885923}\gll hahani       a-va-svek-el-a                        tihlampfi      vapfumba\\
     1.aunt        1.\textstyleFontepargpadroi{\textsc{sm}}\textstyleFontepargpadroi{{}-2.}\textstyleFontepargpadroi{\textsc{om}}\textstyleFontepargpadroi{{}-}cook\textstyleFontepargpadroi{{}-}\textstyleFontepargpadroi{\textsc{appl}}\textstyleFontepargpadroi{{}-}\textstyleFontepargpadroi{\textsc{fv}}\textstyleFontepargpadroi{      10.}fish          2.guest\\
\glt ‘My aunt is cooking fish for them, the guests.’
\z
...
\textstyleFontepargpadroi{\textsc{1  }}\textstyleFontepargpadroi{first person}

\textstyleFontepargpadroi{\textsc{2  }}\textstyleFontepargpadroi{second person}

\textstyleFontepargpadroi{\textsc{3  }}\textstyleFontepargpadroi{third person}

\textstyleFontepargpadroi{\textsc{acc  }}\textstyleFontepargpadroi{accusative}

\textstyleFontepargpadroi{\textsc{ao  }}applied object

\textstyleFontepargpadroi{\textsc{appl  }}\textstyleFontepargpadroi{applicative}

\textstyleFontepargpadroi{\textsc{cont}}\textstyleFontepargpadroi{  contactive}

\textstyleFontepargpadroi{\textsc{def  }}\textstyleFontepargpadroi{definite}

\textstyleFontepargpadroi{\textsc{do  }}direct object

\textsc{dom}  double object marking

\textstyleFontepargpadroi{\textsc{fv  }}final vowel

\textstyleFontepargpadroi{\textsc{inf  }}infinitive

\textstyleFontepargpadroi{\textsc{loc}}  locative

\textstyleFontepargpadroi{\textsc{m  }}masculine

\textstyleFontepargpadroi{\textsc{om  }}object marker

\textstyleFontepargpadroi{\textsc{part  }}particle

\textstyleFontepargpadroi{\textsc{pass  }}passive

\textstyleFontepargpadroi{\textsc{pl  }}plural

\textstyleFontepargpadroi{\textsc{prf  }}perfective

\textstyleFontepargpadroi{\textsc{pst  }}past

\textstyleFontepargpadroi{\textsc{rel}}  relative marker

\textstyleFontepargpadroi{\textsc{sg  }}singular

\textstyleFontepargpadroi{\textsc{sm  }}subject marker

\textstyleFontepargpadroi{\textsc{t}}/\textstyleFontepargpadroi{\textsc{a  }}tense and aspect marker

\section{ References}

Aissen, Judith. 2003. Differential object marking: iconicity vs. economy. \textstyleFontepargpadroi{\textit{Natural Language and Linguistic Theory}} 21. 435-483.

Baker, Mark. 2008. \textstyleFontepargpadroi{\textit{The Syntax of Agreement and Concord}}. Cambridge: Cambridge University Press.

Baker, Mark. 2012. On the relationship of object agreement and accusative case: Evidence from Amharic. \textstyleFontepargpadroi{\textit{Linguistic Inquiry}} 43(2). 255-274.

Bentley, Mayrene. 1994. \textstyleFontepargpadroi{\textit{The Syntactic Effects of Animacy in Bantu Languages}}. Bloomington: Indiana University. (Doctoral dissertation.)

\textstyleFontepargpadroi{Bonga, Lucas dos Anjos Miguel. 2014. }\textstyleFontepargpadroi{\textit{Estudos sobre as restrições de concordância de objeto em Shimakonde}}\textstyleFontepargpadroi{. Maputo: }\textstyleFontepargpadroi{Universidade Eduardo Mondlane. ms.}

\textstyleFontepargpadroi{Bresnan, Joan \& Mchombo, Sam. }1987. Topic, pronoun and agreement in Chichewa. \textstyleFontepargpadroi{\textit{Language}} 63(4). 741-82.

Bresnan, Joan \& Moshi, Lioba. 1990. Object asymmetries in comparative Bantu. \textstyleFontepargpadroi{\textit{Linguistic Inquiry}} 21. 147-185.

Cardinaletti, Anna \& Shlonsky, Ur. 2006. Clitic Positions and Restructuring in Italian. \textstyleFontepargpadroi{\textit{Linguistic Inquiry}} 35(4). 519-557.

Chimbutane, Feliciano. 2002. \textstyleFontepargpadroi{\textit{Grammatical functions in Changana: types, properties and function alternations}}. Canberra: The Australian National University. (Masters dissertation.)

Comrie, Bernard. 1981. \textstyleFontepargpadroi{\textit{Language Universals and Linguistic Typology}}. Oxford: Basil Blackwell.
...
Croft, William. 1988. Agreement vs. case marking and direct objects. In Barlow, Michael \& Ferguson, Charles (eds.), \textstyleFontepargpadroi{\textit{Agreement in natural language: Approaches, theories, descriptions}}. Chicago: University of Chicago Press.

Croft, William. 1990. \textstyleFontepargpadroi{\textit{Typology and Universals}}. Cambridge: Cambridge University Press.

Danon, Gabi. 2002. \textstyleFontepargpadroi{\textit{Case and formal definiteness: The licensing of definite and indefinite noun phrases in Hebrew}}. Telaviv: University of Telaviv. (Doctoral dissertation.)

Diesing, Molly. 1992. \textstyleFontepargpadroi{\textit{Indefinites}}. Cambridge: The MIT Press.

Downing, Laura. 2014. \textstyleFontepargpadroi{\textit{Differential object marking in Chichewa}}. (Paper presented at the workshop of The Diachronic Typology of Differential Argument marking, University of Konstanz, April 5-6, 2014.)

Duarte, Fábio Bonfim. 2011. Tense encoding, agreement patterns, definiteness and relativization strategies in Changana. In Bokamba, Eyamba G. (ed.), \textstyleFontepargpadroi{\textit{Selected Proceedings of the 40th Annual Conference on African Linguistics}}, 80-94. Somerville: Cascadilla Proceedings Project.

Duranti, Alessando. 1979. Object clitic pronouns in Bantu and the topicality hierarchy. \textstyleFontepargpadroi{\textit{Studies in African Linguistics}} 10. 31-45.

Georgopoulos, Carol. 1991. \textstyleFontepargpadroi{\textit{Syntactic Variables: Resumptive pronouns and A' binding in Palauan}}. Dordrecht: Kluwer Academic Publishers.

Givón, Talmy. 1976. Topic, pronoun and grammatical agreement. In Li, Charles (ed.), \textstyleFontepargpadroi{\textit{Subject and Topic}}. New York: Academic Press.

Kimenyi, Alexandre. 1980. \textstyleFontepargpadroi{\textit{A relational grammar of Kinyarwanda}}. Berkeley: University of California Press.

Kramer, Ruth. 2014. Clitic doubling or object agreement: The view from Amharic. \textstyleFontepargpadroi{\textit{Natural Language and Linguistic Theory}} 32. 593-634.

Jelinek, Eloise. 1989. The case split and pronominal arguments in Choctaw. In Maracz, La\'{ }szló \& Muysken, Pieter (eds.), \textstyleFontepargpadroi{\textit{Configurationality: The typology of asymmetries}}. Dordrecht: Foris Publications.
...
Ngonyani, Deo \& Githinji, Peter. 2006. The asymmetric nature of Bantu applicative constructions. \textstyleFontepargpadroi{\textit{Lingua }}116. 31-63.

Woolford, Ellen. 2000. Object agreement in Palauan: Specificity, humanness, economy, and optimality. In Paul, Ileana \& Phillips, Vivianne \& Travis, Lisa (eds.), \textstyleFontepargpadroi{\textit{Formal Issues in Austronesian Linguistics}}, 215-245. Dordrecht: Kluwer Publishers.

Woolford, Ellen. 2001. Conditions on object Agreement in Ruwund (Bantu). In Benedicto, Elena (ed.), \textstyleFontepargpadroi{\textit{The UMass volume on indigenous languages}}. Amherst: GLSA.
