...
\maketitle
\begin{document}
\todo{list of authors too long for header, dropped `Saúl'}
...
\todo{alignment is off. Presumably, `a' should be glossed to correct this}
\ea\label{ex:nguna:2}
\ea
