...
\emph{\textup{\figref{fig:1}:}}  \emph{\textbf{ù}}\emph{\textbf{ }}\emph{  dìì-}\emph{\textbf{wó}}\emph{  }\textit{\textsuperscript{!}}\emph{sááŋ}  ‘s/he ate TZ’    (a type of porridge)

The frequency, in Hertz \footnote{ Reading the data in semitones is also an option in Speech Analyzer, and would be reported if there had been a mixed gender sample.} is read directly off a part of the graph not included in \figref{fig:1}. The frequency was read at either the stable part of the vowel or, lacking a flat portion of the frequency, at the midpoint of the vowel.  The \emph{base} \emph{pitch level} in \figref{fig:1} is the frequency at the left cursor, i.e. at the Low toned [ù]. The \emph{pitch range} is the difference between this Low and the High of the [wó] syllable at the right cursor. 
...
\emph{\textbf{\textup{\tabref{tab:3}:}}}\textbf{ ‘}\textbf{S/he has cooked yams’  }\emph{\textbf{ù dìgìwó nyʊà}}\textbf{  (Solomon) }
...
\lspbottomrule
\end{tabular}
\emph{\textbf{\textup{\tabref{tab:4}:}}}\textbf{ ‘}\textbf{S/he has cooked yams’  }\emph{\textbf{ù dìgìwó nyʊà}}\textbf{  (Salifu)}
...
\emph{\textbf{\textup{\tabref{tab:5}:}}}\textbf{ Properties of emotions in Kɔnni, compared to neutral sentence intonation }
...
\item \textstyleStrong{\textmd{Surprise}} is straightforwardly \emph{wuboŋkiŋ}. 
\item \textstyleStrong{\textmd{Boredom}} is expressed as \emph{wʋkpaaŋ} (the idea is “too much talking/too many issues”).
...
\end{itemize}
\item For \textstyleStrong{\textmd{emphasis}}, Saibu suggested \textit{Vii balɩ} which literally means ‘say it again,’ which would make the speaker assume the original hearer didn’t quite understand it, and she or he should repeat it more understandably. This is not a direct translation of the English term \emph{emphasis}, but probably evokes the corresponding pronunciation.
\end{itemize}
...
\lspbottomrule
\end{tabular}
\emph{\textbf{\textup{\tabref{tab:8}:}}}\textbf{ ‘}\textbf{S/he has bought oil’  }\emph{\textbf{ʊ}}\emph{\textbf{ dàà}}\emph{\textbf{wá}}\emph{\textbf{ kpááŋ}}\textbf{  (Salifu)}
...
\lspbottomrule
\end{tabular}
\textbf{ }\emph{\textbf{\textup{\tabref{tab:9}:}}}\textbf{ ‘}\textbf{S/he has cooked eggs’  }\emph{\textbf{ù}}\emph{\textbf{ dìgì}}\emph{\textbf{wó}}\emph{\textbf{ gɪlà}}\textbf{  (Salifu)}
...
\lspbottomrule
\end{tabular}
\emph{\textbf{\textup{\tabref{tab:10}:}}}\textbf{ ‘S}\textbf{/he has fried eggs’   }\emph{\textbf{ʊ}}\emph{\textbf{ chʊŋ}}\emph{\textbf{wá}}\emph{\textbf{ gɪlà}}\textbf{  (Salifu)}
...
\lspbottomrule
\end{tabular}
\emph{\textbf{\textup{\tabref{tab:11}:}}}\textbf{ ‘S}\textbf{/he has eaten TZ’  }\emph{\textbf{ù}}\emph{\textbf{ dùù}}\emph{\textbf{wó}}\emph{\textbf{ }}\textit{\textsuperscript{!}}\emph{\textbf{sááŋ}}\textbf{  (Salifu)}
...
\lspbottomrule
\end{tabular}
\emph{\textbf{\textup{\tabref{tab:12}:}}}\textbf{  ‘S}\textbf{/he has fetched fire’  }\emph{\textbf{ʊ}}\emph{\textbf{ chɔgɪsɪ}}\emph{\textbf{wó}}\emph{\textbf{ }}\textbf{\textsuperscript{!}}\emph{\textbf{bólíŋ}}\textbf{  (Salifu)}
