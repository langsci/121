...
\textsc{cl7-refl}-wash-\textsc{prs}\\ 
 ‘It washes itself.’ \\
  \\ 
{\dummyslash}keisiŋgaa   \>     /j̪/Deletion{\footnotemark}\\
{\dummyslash}kjiisiŋgaa  \>  Gliding and Compensatory Lengthening\\
{\dummyslash}t͡ʃiisiŋgaa  \>  Consonant-Glide Reduction\\
{[t͡ʃiisiŋgaa]} \>   \\
\end{tabbing}
% \end{tabular}
\z
...
\ea\label{ex:glewwe:12}{}
  ...
  \gll /d͡ʒirit͡ʃi/  [ed͡ʒiɾit͡ʒi]\\
  bull  \textsc{cl9}-bull\\
   \glt   ‘bull’

  \ex\label{ex:glewwe:12d}{}
  \gll /t͡ʃɛɛre/  [m̩t͡ʃɛɛɾe]\\
  rice  \textsc{cl3}-rice\\
  \glt    ‘rice’
  \z
\z 
