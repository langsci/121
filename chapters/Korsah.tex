...
\begin{list}
\item i. \textsc{person}: Participant (i.e.\ 1st/2nd person) or Non-participant (i.e.\ 3rd person).

\item ii. \textsc{number}: Singular (Sg) or Plural (Pl)
 
\item iii. \textsc{animacy}: Animate or Inanimate (Inan)
\end{list} 
