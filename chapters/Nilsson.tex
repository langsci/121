...
Some examples of actual occurrences of these articles are given in \tabref{tab:2}. The ordering of suffixes added to noun stems is 
1) plural morpheme, 
...
\begin{tabularx}{\textwidth}{XXXlX} & {\textsc{sg.def}} &  & {\textsc{pl.def}} & \\
\lsptoprule
{\textsc{m}}
