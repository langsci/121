...
\ea\label{ex:mcpherson:1a} {\it \textipa{\H*a}} `3\textsc{sg}' \\
{\it \textipa{\'a}} `2\textsc{sg}' \\
\ex\label{ex:mcpherson:1b} {\it \textipa{m\'o}} `1\textsc{sg}' \\
{\it \textipa{m\H{{\i}}}} `1\textsc{pl}' \\
\z
\z
...
\ea\label{ex:mcpherson:3} {\it \textipa{k\^{\~u}\~{\i}}}  `{\it n\'er\'e} seeds' \\
{\it \textipa{k\v{\~u}\~{\i}}} `grass sp.' \\
\z
...
\ea\label{ex:mcpherson:7a} {\it \textipa{j\H*oNw\H{a}}} $\rightarrow$ {\it \textipa{j\H*oNw\H{E}}} `cat(s)' \\
\ex\label{ex:mcpherson:7b} {\it \textipa{d\H*a\^a}} $\rightarrow$ {\it \textipa{d\H*E\H{E}}} `basket hanger(s)' \\
\z
\z
...
Before we turn to the alternations, the inventory of Seenku pronouns is summarized in \REF{ex:mcpherson:18}:
...
\ea\label{ex:mcpherson:20a} {\it \textipa{b\H*EE} \textipa{s\H*{\~a}}} `buy a pig!' \\
\ex\label{ex:mcpherson:20b} {\it \textipa{b\`EE} \textipa{s\`{\~a}}} `buy pigs!' \\
\ex\label{ex:mcpherson:20c} {\it \textipa{b\H{\i}} \textipa{s\H{\~a}}} `buy goats!' \\
\z
\z
...
\ea\label{ex:mcpherson:21a} /eL/ {\it \textipa{b\H*EE} \textipa{s\H*{\~a}}} `buy a pig!' \\
\ex\label{ex:mcpherson:21b} /H/ {\it \textipa{b\H*EE} \textipa{s\H*OO}} `sell a pig!' \\
\ex\label{ex:mcpherson:21c} /eH/ {\it \textipa{b\H*EE} \textipa{b\H*{\~a}}} `hit a pig!' \\
\z
\z
