...
\ea\label{ex:mcpherson:2} {\it Tonal minimal sets contrasting X, H, and S} \\
...
The other attested underlying contour is the tritone sequence XHX, as in {\it \textipa{d\H*{a}\^a}} `basket hanger'.
...
\ea\label{ex:mcpherson:9} {\it /H/ singular $\rightarrow$ S plural} \\
\begin{tabular}[t]{lll}
...
S & \textbf{\textipa{\H*a b\H{\~a}}} & `hit it' \\
...
\ea\label{ex:mcpherson:14} {\it Addition of transitive S and intransitive X in postpositional forms} \\
\begin{tabular}[t]{lll}
  a. & {Transitive} &  \\
...
\ea\label{ex:mcpherson:23} {\it Example of [-raised] spreading from H to S} \\
...
\ea\label{ex:mcpherson:25} {\it example of [+upper] spreading from H to X} \\
